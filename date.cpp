...
bool Date::set_date(int day, int month, int year){
    ...
    if (check_date()==false){
        cout << "Error! Invalid date!" << endl;
        cout << "Date set to default!" << endl;
        this->day = 1;          // Fixed to this->day rather than argument day.
        this->month = 1;        // Fixed to this->month rather than argument month.
        this->year = 1970;      // Fixed to this->year rather than argument year.
        return false;
    }
    return true;
}
